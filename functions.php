...
function theme_name_scripts() {
	wp_enqueue_style( 'theme-name-main', get_template_directory_uri() . '/assets/css/main.css' );

	wp_enqueue_style( 'theme-name-style', get_stylesheet_uri() );

	wp_enqueue_script( 'theme-name-navigation', get_template_directory_uri() . '/assets/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'theme-name-skip-link-focus-fix', get_template_directory_uri() . '/assets/js/skip-link-focus-fix.js', array(), '20151215', true );
